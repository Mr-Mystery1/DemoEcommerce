    ...
    public class UserRepository(AuthenticationDbContext context, IConfiguration config) : IUser
    {
        ...
        public async Task<Response> Register(AppUserDTO appUserDTO)
        {
            ...
            if (getUser is not null)
                return new Response(false, $"You can't use this email for registration..");
            ...
            return result.Entity.Id > 0 ? new Response(true, "User registered..") : new Response(false, "Invalid data provided..");
